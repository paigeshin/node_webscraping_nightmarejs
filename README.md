...
```bash
npm i nightmarejs request request-promise cheerio
```
...
- Some website is rendered from javascript.
- You can't download html because it's rendered from javascript.
- Nightmare ⇒ render the website, not download the website.
- Request ⇒ Download the website.

# Project built with me
